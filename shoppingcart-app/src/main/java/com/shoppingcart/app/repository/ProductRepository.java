...
public interface ProductRepository extends JpaRepository<Product, Long> {
	...
	@Query(value = "SELECT p FROM Product p WHERE productName = ?1 AND productScale = ?2")
	public List<Product> findByProductNameAndProductscale(String productName, String productScale);
