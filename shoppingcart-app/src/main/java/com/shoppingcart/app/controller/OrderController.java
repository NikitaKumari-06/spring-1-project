...
public class OrderController {
	...
	//get all Order handler by comment
	@GetMapping("orders/comment/{comments}")
	public ResponseEntity<List<Order>> getOrderByComments(@PathVariable("comments") String comments) throws OrderNotFoundException{
		List<Order> order = orderService.getOrderByComments(comments);
	...
	//sorting implementation by order date
