...
public class CustomerController {
	...
	//get Customer handler by customerName
	@GetMapping("customers/name/{customerName}")
	public ResponseEntity<List<Customer>> getCustomerByName(@PathVariable("customerName") String customerName) throws CustomerNotFoundException{
	...
	//sorting implementation by addressLine1
