...
public class EmployeeController {
	...
	//get single Employee handler by email
	@GetMapping("employees/mail/{email}")
	public ResponseEntity<Employee> getEmployeeByEmail(@PathVariable("email") String email) throws EmployeeNotFoundException{
		Employee employee = employeeService.getEmployeeByEmail(email);
		
		if(employee == null) {
			throw new EmployeeNotFoundException("Employee not exists : " + email);
		}
		return ResponseEntity.of(Optional.of(employee));
	}
	...
	public ResponseEntity<List<Employee>> getEmployeeByName(@PathVariable("firstName") String firstName) throws EmployeeNotFoundException{
		List<Employee> employee = employeeService.getEmployeeByName(firstName);
		
		if(employee == null) {
			throw new EmployeeNotFoundException("Employee not exists with name : " + firstName);
		}
		return ResponseEntity.of(Optional.of(employee));
	}
	...
	//sorting implementation by job title
