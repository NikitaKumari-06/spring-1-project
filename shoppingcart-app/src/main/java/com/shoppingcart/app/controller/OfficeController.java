...
public class OfficeController {
	...
	//get Offices handler by city
	@GetMapping("offices/city/{city}")
	public ResponseEntity<List<Office>> getOfficeByCity(@PathVariable("city") String city) throws OfficeNotFoundException{
		List<Office> office = officeService.getOfficeByCity(city);
	...
	//get Offices handler by country and state
	@GetMapping("offices/country/{country}/{state}")
	public ResponseEntity<List<Office>> getOfficeByCountryAndState(@PathVariable("country") String country, @PathVariable("state") String state) throws OfficeNotFoundException{
		List<Office> office = officeService.getOfficeByCountryAndState(country, state);
		
		if(office == null) {
			throw new OfficeNotFoundException("Office not exists with country : " + country + " and state : " + state);
		}
		return ResponseEntity.of(Optional.of(office));
	}
	...
	//sorting implementation by postal code
