...
public class ProductServiceImpl implements ProductService {
	...
	//get all Products by matched product name and product scale
	@Override
	public List<Product> getProductByNameAndScale(String productName, String productScale) {
		List<Product> list = productRepository.findByProductNameAndProductscale(productName, productScale);
		return list;
	}
