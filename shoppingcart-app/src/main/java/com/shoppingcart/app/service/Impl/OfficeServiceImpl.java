...
public class OfficeServiceImpl implements OfficeService {
	...
	//get all Offices by matched city
	@Override
	public List<Office> getOfficeByCity(String city) {
		List<Office> list = officeRepository.findByCity(city);
		return list;
	}
	...
	//get all Offices by matched country and state
	@Override
	public List<Office> getOfficeByCountryAndState(String country, String state) {
		List<Office> list = officeRepository.findByCountryAndState(country, state);
		return list;
	}
	...
	//get Offices sorted by postalCode using Sorting
	@Override
	public Iterable<Office> getSortOfficesUsingSorting() {
		String sortBy = "postalCode";
