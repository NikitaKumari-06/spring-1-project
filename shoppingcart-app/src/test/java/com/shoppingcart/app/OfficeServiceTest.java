...
public class OfficeServiceTest {
	...
	@Test
	public void getOfficeByCityTest() {
		Office office = new Office();
		...
		Mockito.when(officeRepository.save(office)).
		thenReturn(office);
		assertThat(officeService.getOfficeByCity("Gaya")).
		isNotNull();
	}
	...
	@Test
	public void getOfficeByCountryAndStateTest() {
		Office office = new Office();
		...
		Mockito.when(officeRepository.save(office)).
		thenReturn(office);
		assertThat(officeService.getOfficeByCountryAndState("India", "Bihar")).
		isNotNull();
	}
